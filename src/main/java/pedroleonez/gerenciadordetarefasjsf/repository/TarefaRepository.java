...
public class TarefaRepository {
    ...
    public TarefaRepository() {
        if (emf == null) {
            try {
                ...
                System.err.println("⚠️ Falha ao inicializar EntityManagerFactory: " + e.getMessage());
                e.printStackTrace();
            }
        }
    }
    ...
    public List<Tarefa> filtrar(Long id, String tituloOuDescricao, String responsavel,
        ...
        try {
            ...
            if (prioridade != null) jpql.append(" AND t.prioridade = :prioridade");
            if (situacao != null) jpql.append(" AND t.situacao = :situacao");
